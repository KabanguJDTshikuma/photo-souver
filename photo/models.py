...
class Portrait_detail(models.Model):
    portait_id = models.ForeignKey(
        Portrait, models.SET_NULL, blank=True, null=True)
    portrait_detail = models.ImageField(upload_to='images/')


class Lifestyle_detail(models.Model):
    lifestyle_id = models.ForeignKey(
        Lifestyle, models.SET_NULL, blank=True, null=True)
    lifestyle_detail = models.ImageField(upload_to='images/')


class Wedding_detail(models.Model):
    wedding_id = models.ForeignKey(
        Wedding, models.SET_NULL, blank=True, null=True)
